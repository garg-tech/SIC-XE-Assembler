...
// Function to check if the line is a comment line
...
// Function to read the first non-whitespace character
...
// Function to get the real opcode (exclulding its format)
...
// Function to get the format of the opcode
...
// Class to create some basic string functions
